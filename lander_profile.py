...
frame.add_joint(members=[beams[4], beams[6], beams[15], beams[16], beams[21], beams[22]], nodes=[ne, ne, 0, 0, ne, 0])
frame.add_joint(members=[beams[7], beams[9], beams[17], beams[18], beams[22], beams[23]], nodes=[ne, ne, 0, 0, ne, 0])
