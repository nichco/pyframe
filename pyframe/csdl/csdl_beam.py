...
class CSDLBeam:
    ...
    def add_inertial_mass(self, mass, node):
        self.extra_inertial_mass[node] += mass
    ...
    def _local_stiffness_matrices(self):
        ...
        local_stiffness = local_stiffness.set(csdl.slice[:, 0, 0], A*E/L)
        ...
        local_stiffness = local_stiffness.set(csdl.slice[:, 3, 3], G*J/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 4, 4], 4*EIy/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 5, 5], 4*EIz/L)

        local_stiffness = local_stiffness.set(csdl.slice[:, 0, 6], -A*E/L)
        ...
        local_stiffness = local_stiffness.set(csdl.slice[:, 3, 9], -G*J/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 4, 8], 6*EIyL2)
        local_stiffness = local_stiffness.set(csdl.slice[:, 4, 10], 2*EIy/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 5, 7], -6*EIzL2)
        local_stiffness = local_stiffness.set(csdl.slice[:, 5, 11], 2*EIz/L)

        local_stiffness = local_stiffness.set(csdl.slice[:, 6, 0], -A*E/L)
        ...
        local_stiffness = local_stiffness.set(csdl.slice[:, 9, 3], -G*J/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 10, 2], -6*EIyL2)
        local_stiffness = local_stiffness.set(csdl.slice[:, 10, 4], 2*EIy/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 11, 1], 6*EIzL2)
        local_stiffness = local_stiffness.set(csdl.slice[:, 11, 5], 2*EIz/L)

        local_stiffness = local_stiffness.set(csdl.slice[:, 6, 6], A*E/L)
        ...
        local_stiffness = local_stiffness.set(csdl.slice[:, 9, 9], G*J/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 10, 10], 4*EIy/L)
        local_stiffness = local_stiffness.set(csdl.slice[:, 11, 11], 4*EIz/L)
