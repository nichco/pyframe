...
class CSTube:
    ...
    def stress(self, element_loads, i):

        F_x1, F_y1, F_z1, M_x1, M_y1, M_z1 = element_loads[:6]
        F_x2, F_y2, F_z2, M_x2, M_y2, M_z2 = element_loads[6:]
        ...
        axial_stress = F_x / self.area()[i]
        shear_stress = M_x * self.radius[i] / self.ix()[i]

        max_moment = (M_y**2 + M_z**2 + 1E-12)**0.5
        bending_stress = max_moment * self.radius[i] / self.iy()[i]
